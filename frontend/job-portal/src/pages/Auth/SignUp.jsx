...
import { validateAvatar, validatePassword,validateEmail } from "../utils/helper";
...
const SignUp = () => {
  ...
  // generic input change (works for text inputs)
 const handleInputChange = (e) => {
  ...
  // handle avatar file input & preview
  ...
  if (file) {
    ...
    reader.onload = (e) => {
      setFormState(prev => ({
        ...prev,
        avatarPreview: e.target.result,  // not inside formData
        errors: { ...prev.errors, avatar: "" }  // correct place
      }));
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          ...
          <div>
            ...
            {formState.errors.role && (
              <p className="text-red-500 text-sm mt-2 flex items-center" role="alert">
                <AlertCircle className="w-4 h-4 mr-1" />
                {formState.errors.role}
              </p>
            )}
          ...
          <button
            ...
            className="w-full mt-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
          >
            {formState.loading ? (
              <>
