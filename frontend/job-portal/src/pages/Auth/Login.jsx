  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormState(prev=>({
        ...
        loading:false,
        errors:{
          submit:error.response?.data?.message || "Login failed. Please check your login credentials."
        }
      }))
    }
    ...
    return(
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">You have been succefully logged in</p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to JobPortal account</p>
        </div>
