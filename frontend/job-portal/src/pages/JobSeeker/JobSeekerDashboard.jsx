...
const JobSeekerDashboard = () => {
  ...
  const fetchJobs = async (filterparams = {}) => {
    try{
      ...
      if(filterparams.keyword) params.append("keyword",filterparams.key);
  ...
  const applyToJob=async(jobId)=>{
    try{
      ...
      toast.error(errorMsg || "Semething went wrong! Try again later")
    }
  }
      ...
      <div className="min-h-screen mt-16">
        ...
        <div className="flex gap-6 lg:gap-8">
          ...
          <div className="flex-1 min-w-0">
            {/* Results Header */}
            <div className="flex flex-col lj:flex-row lg:items-center justify-between mb-6 lg:mb-8 gap-4">
              <div>
