...
const SavedJobs = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-putple-50">
      <Navbar />
                ...
                >
                  {savedJobList.map((savedJob) => (
                    <JobCard
                      ...
                      onToggleSave={() =>
                        handleUnsavedJob(savedJob?.job._id)
                      }
                      saved
                    />
                  ))}
