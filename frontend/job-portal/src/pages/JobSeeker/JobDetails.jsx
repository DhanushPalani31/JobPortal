            ...
            <div className="relative px-0 pb-8 border-b border-gray-100">
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-blue-50 text-ms text-blue-700 font-semibold rounded-full border border-blue-200">{jobDetails.category}</span>
                  <span className="px-4 py-2 text-sm bg-purple-50 text-purple-700 font-semibold rounded-full border border-purple-200">{jobDetails.type}</span>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                          ...
                          <span className="text-lg">What we're Looking</span>
                        </h3>
