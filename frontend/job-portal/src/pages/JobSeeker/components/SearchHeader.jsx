...
const SearchHeader = ({filters,handleFilterChange}) => {
  return (
    <div className='bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-gray-200 border border-white/20 p-4 lg:p-8 mb-8 lg:mb-8'>
      <div className='flex flex-col gap-4 lg:gap-6'>
        ...
        <div className='flex flex-col lg:flex-row gap-3 lg:gap-4'>
            <div className='flex-1 relative'>
                ...
                <div className='relative min-w-0  lg:win-w-[200px]'>
