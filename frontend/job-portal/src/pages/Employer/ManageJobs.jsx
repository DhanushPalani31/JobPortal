...
const ManageJobs = () => {
  ...
  try {
    ...
    // Force refresh of jobs after toggle
    ...
    <tr className='animate-pulse'>
      <td className='px-6 py-4'>
         <div className='flex items-center space-x-3'>
          <div className='w-10 h-10 bg-gray-200 rounded-full w-16'></div>
  ...
  const getPostedJobs=async(diasbleLoadder)=>{
    setIsLoading(!diasbleLoadder)
    try {
                  ...
                  <tbody className='bg-white divide-y divide-gray-200'>
                    {
                      ...
                      :paginatedJobs.map((job)=>(
                        ...
                        className='hover:bg-blue-50/30 transition-all duration-200 border-b border-gray-100/60'>
                          ...
                          <td className='px-6 py-4 whitespace-nowrap text-sm font-medium min-w-[100px] sm:min-w-0'>
                            <div className='flex space-x-2'>
                              <button
                ...
                </button>
                {
                  Array.from({length:totalPages},(_,i)=>i+1).map(
                    (page)=>{
                      ...
                      className={`realtive inline-flex items-center px-4 py-2 border text-sm font-medium ${
                        currentPage===page
