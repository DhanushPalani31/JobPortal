              ...
              <div className='p-8'>
                      ...
                      <div className='relative'>
                        ...
                        {uploading?.avatar && (
                          <div className='absolute inset-0 bg-black bg-opacity-50 rounded-full flex items-center justify-center'>
                            <div className='w-6 h-6 borer-2 border-white border-t-transparent rounded-full animate-spin'></div>
                          </div>
                        )}
                      </div>
                    </div>
                ...
                <div className='flex justify-end space-x-4 mt-8 pt-6 border-t'>
                  <button
                    ...
                    className='px-6 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors flex items-center space-x-2'
                  >
                    <X className='w-4 h-4' />
                    <span>Cancel</span>
                  </button>
                  <button
                    ...
                    className='px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-no-allowed transition-colors flex items-center space-x-2'
                  >
                    {saving ? (
